...
sys.path.insert(0, os.path.abspath('../../firmware/tools'))


# -- Project information -----------------------------------------------------

project = 'Buoy Controller v1'
copyright = '2020, Andrea Corbo'
author = 'Andrea Corbo'

# The full version, including alpha/beta/rc tags
version = release = '1.1 stable'
...
htmlhelp_basename = 'BuoyControllerv1doc'
...
latex_documents = [
    (master_doc, 'BuoyControllerv1.tex', 'Buoy Controller v1 Documentation',
     'Andrea Corbo', 'manual'),
]
...
man_pages = [
    (master_doc, 'buoycontrollerv1', 'Buoy Controller v1 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'BuoyControllerv1', 'Buoy Controller v1 Documentation',
     author, 'BuoyControllerv1', 'One line description of project.',
     'Miscellaneous'),
]

...
A ``firmware_uploader.sh`` bash script compiles ad flashes the
...
connect DFU pin with 3v3 and push the reset button.
...
.. code-block:: bash
    ...
    $ sudo apt install python-usb python3-usb gcc-arm-none-eabi binutils-arm-none-eabi openocd
